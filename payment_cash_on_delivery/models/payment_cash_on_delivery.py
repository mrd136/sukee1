...
class WkCOD(models.Model):
    ...
    def _default_policy_content(self):
        ...
        min_order_amount, max_order_amount = self.min_order_amount or 10, self.max_order_amount or 10000
        if currency_symbol:
            ...
            return "Order Order Amount Must Be in Between 10€ 10000€"
